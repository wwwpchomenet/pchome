...
<section> 
  ...
  <div id="slideBox" class="slideBox">
    <div class="bd">
      <ul>
          <!--轮播图展示-->
          <?php if(is_array($rows)): foreach($rows as $key=>$row): ?><li><a href="<?php echo ($row["link"]); ?>" title=""><img src="http://www.wap.com/Uploads/<?php echo ($row["path"]); ?>"  alt="" /></a></li><?php endforeach; endif; ?>
      </ul>
    </div>
    <div class="hd">
      <ul>
  ...
  <div class="menu">
    <ul>
      <li><a href="<?php echo U('index.php/Admin/PersonalCenter/index');?>"><i><img src="http://www.wap.com/iphone/Public/Images/menu_icon1.png" /></i>
        <p>帐号管理</p>
        </a></li>
      <li><a href="<?php echo U('index.php/Admin/OrderInfo/setlist');?>"><i><img src="http://www.wap.com/iphone/Public/Images/menu_icon2.png"  /></i>
        <p>我的订单</p>
        </a></li>
      <li><a href="<?php echo U('index.php/Admin/Wallet/wallet');?>"><i><img src="http://www.wap.com/iphone/Public/Images/menu_icon3.png" /></i>
        <p>我的钱包</p>
        </a></li>
      <li><a href="<?php echo U('index.php/Admin/Address/index');?>"><i><img src="http://www.wap.com/iphone/Public/Images/menu_icon4.png" /></i>
        <p>收货地址</p>
        </a></li>
    </ul>
  </div>
