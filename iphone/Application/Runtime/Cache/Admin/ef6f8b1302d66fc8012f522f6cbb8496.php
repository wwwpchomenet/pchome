    ...
    <section>
        ...
        <div class="ord_top">
            ...
            <?php if(is_array($goodsList)): foreach($goodsList as $key=>$goodsList): ?><div class="ord_qingdan">
                    <div class="ord_con">
                        <div class="ord_qingdan_tu fl"><img src="http://www.wap.com/Uploads/<?php echo $goodsAll['logo'];?>" /> </div>
                        <div class="ord_qingdan_text fl">
                            ...
                            <p class="ord_qingdan_name_jiage js_danjia fr"><?php echo $goodsList['market_price'];?><span>元/件</span></p>
                            ...
                            <p style="display:none;" class="js_bb">需支付￥<?php echo $goodsList['market_price']*$goodsList['num'];?>元</p>
    ...
    <script type="text/javascript">
        ...
        $(function(){
                $('.in_footer_lish_tu3').css({
                    width:26+'px',
                    height:26+'px',
                    background:'url(http://www.wap.com/Public/Images/icon.png)',
